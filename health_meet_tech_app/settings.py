"""
Django settings for health_meet_tech_app project.
...
ROOT_URLCONF = 'health_meet_tech_app.urls'
...
WSGI_APPLICATION = 'health_meet_tech_app.wsgi.application'
